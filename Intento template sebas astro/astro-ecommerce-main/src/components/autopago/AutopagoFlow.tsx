...
const AutopagoFlow: React.FC = () => {
  ...
  const renderContenido = () => {
    switch (estadoActual) {
      ...
      case 'identificacion':
        return (
          <div className="min-h-[calc(100vh-160px)] flex items-center justify-center bg-gray-50 py-8"> {/* Ajuste para altura y centrado */}
      ...
      case 'registro':
        return (
          <div className="min-h-[calc(100vh-160px)] flex items-center justify-center bg-gray-50 py-8">
            <RegistroCliente
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans antialiased">
      ...
      <main className="flex-grow"> {/* Permite que el contenido ocupe el espacio restante */}
        {renderContenido()}
      </main>
    </div>
  );
